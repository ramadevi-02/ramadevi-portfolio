  ...
  return (
    <section id="about" className="py-20 px-6 md:px-20 bg-gray-900">
      ...
      <p className="text-gray-300 max-w-3xl mb-4">
        I am a motivated Java Full Stack Developer with hands-on experience in developing web applications using Java, React.js, and SQL. I have a strong understanding of core Java concepts, object-oriented programming, and database-driven application development.
      </p>
